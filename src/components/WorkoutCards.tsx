...
const WorkoutCards: React.FC<WorkoutCardsProps> = ({ workout }) => {
  return (
    <div className="bg-[#12141a] border border-gray-800/80 rounded-2xl p-4 flex flex-col justify-between hover:border-gray-700 transition-all duration-300">
      <div>
        {/* Card Image Container */}
        <div className="relative w-full h-110 rounded-xl overflow-hidden mb-4 bg-gray-900">
          <Image
            src={workout.image}
            alt={workout.name}
            fill
